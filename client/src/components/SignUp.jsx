                  ...
                  >
                    ...
                    <div className='mt-2'>
                      <CustomButton
                        type='submit'
                        disabled={isLoading}
                        containerStyles={`inline-flex justify-center rounded-md bg-blue-600 px-8 py-2 text-sm font-medium text-white outline-none hover:bg-blue-800 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        title={isLoading ? "Please wait..." : (isRegister ? "Create Account" : "Login Account")}
                      />
                    </div>
                  </form>
